            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-neutral-200 bg-neutral-50 py-2.5 pl-10 pr-10 text-sm text-neutral-900 placeholder-neutral-400 focus:border-brand-green focus:bg-white focus:ring-1 focus:ring-brand-green focus:outline-none transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
